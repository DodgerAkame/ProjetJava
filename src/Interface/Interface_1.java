...
public class Interface_1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        inter.getTampon1().setAdr(dropPane1.getAdresse2());
        inter.getTampon1().setImg(dropPane1.getImagef());
        inter.getTampon1().setA(dropPane1.getAa());
        inter.getTampon1().setB(dropPane1.getBb());
