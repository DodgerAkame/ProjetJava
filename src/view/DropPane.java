...
public class DropPane extends JPanel implements ActionListener {
    ...
    /**
     * getter droptarget if drop target is null : instance of droptarget
     */
    ...
    /**
     * getter dropTargetHandler if dropTargetHandler is null : instance of
     * dropTargetHandler
     */
    ...
    /**
     * create a list of ImageIcon resizes and define a limit of memory use for
     * images (500 Mbytes)
     *
     * @param img
     */
