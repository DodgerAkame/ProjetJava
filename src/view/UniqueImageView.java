 ...
 * @author Melh
 */
public class UniqueImageView extends javax.swing.JFrame {

    /**
     * Creates new form UniqueImageView
     */
    public UniqueImageView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UniqueImageView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UniqueImageView().setVisible(true);
            }
        });
    }
